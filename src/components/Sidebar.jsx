...
export default function Sidebar({ active, onNavigate, openSignal = 0, mobileOpen, onMobileOpenChange }) {
  ...
  const STEPS = [
    ...
    { id: 'videoAnalyzer', label: t('videoAnalyzer'), step: '31b0' },
    { id: 'dinoJump', label: 'AI camera control dino jump', step: '31b1' },
    { id: 'remixSucKhoeKOL', label: t('remixSucKhoeKOL'), step: '31b1' },
    { id: 'vibeTracking', label: t('vibeTracking'), step: '31b2' },
    { id: 'vibeCheck', label: t('vibeCheck'), step: '31b3' },
    { id: 'videoToLearning', label: t('videoToLearning'), step: '31c' },
    { id: 'bringAnyIdeaToLife', label: t('bringAnyIdeaToLife'), step: '31d' },
  ...
  const sidebarContent = (
    <>
      ...
      <NavItem active={active === 'aiChatbotControl'} onClick={() => handleNavigate('aiChatbotControl')} text={text} text2={text2} isDark={isDark}>
        <span style={{ fontSize: 13 }}>🤖</span>
        <span style={{ flex: 1 }}>{t('nav_aiChatbotControl')}</span>
        <span style={{ fontSize: 10, fontFamily: 'monospace', color: text3 }}>BOT</span>
      </NavItem>
